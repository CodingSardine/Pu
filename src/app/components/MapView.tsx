...
export default function MapView({
  ...
  const locations = useMemo<Record<Mode, LocationEntry[]>>(
    () => ({
      ...
      chill: [
        { id: 'k11', lat: 35.1756, lng: 33.3612, name: 'K11', address: 'Nicosia Old Town', hours: '10am – 12am', cuisine: 'Cocktails + Bites', price: '€€', atmosphere: 'Artsy & Eclectic', seating: 'Indoor + Courtyard', gmaps: 'https://www.google.com/maps/search/?api=1&query=K11+Bar+Nicosia', features: ['outdoor', 'pet-friendly'], mode: 'chill' },
